...
- (void)viewDidLoad {
    ...
    self.display =
        MakeLabel(@"0", 42, UIFontWeightBold);
...
- (void)buttonPressed:(UIButton *)sender {
    ...
    if ([value isEqualToString:@"="]) {
        ...
        if ([self.operation isEqualToString:@"+"]) {
            ...
            result =
                [self.firstNumber decimalNumberByAdding:second];
        }
        else if ([self.operation isEqualToString:@"−"]) {

            result =
                [self.firstNumber decimalNumberBySubtracting:second];
        }
        else if ([self.operation isEqualToString:@"×"]) {

            result =
                [self.firstNumber decimalNumberByMultiplyingBy:second];
        }
        else if ([self.operation isEqualToString:@"÷"]) {

            if ([second isEqualToNumber:
            ...
            result =
                [self.firstNumber decimalNumberByDividingBy:second];
        }
    ...
    if ([self.current isEqualToString:@"0"]) {
        ...
        self.current =
            [self.current stringByAppendingString:value];
    }
...
- (void)viewDidLoad {
    ...
    [NSLayoutConstraint activateConstraints:@[
        ...
        [self.minField.widthAnchor
            constraintEqualToConstant:140],
